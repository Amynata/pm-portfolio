// Données statiques du portfolio : i18n, formations, expériences, outils, certifications.
// Séparées de la logique UI pour faciliter les mises à jour de contenu.
...
export const translations = {
    FR: {
      ...
      heroCtaProjects: 'Projets produit',
      heroCtaAutomations: 'Workflows n8n',
      heroCtaCv: 'Mon CV',
      n8nCrumb: 'Automatisations',
      n8nEyebrow: 'Builder · No-code & Automation',
      n8nTitle: 'Mes automatisations',
      n8nIntro: "Choisissez une automatisation : démo Loom, architecture de nœuds et compétences mobilisées. Une démo à la fois — rien ne charge tant que vous ne l'ouvrez pas.",
      n8nBack: 'Hub',
      n8nNeed: 'Le besoin',
      n8nSolution: 'La solution',
      n8nApps: 'Apps connectées',
      n8nSkills: 'Compétences n8n démontrées',
      n8nFlow: 'Architecture du flow',
      n8nInput: 'Input',
      n8nEngine: 'Moteur n8n',
      n8nOutput: 'Output',
      n8nSub: 'Sous-workflows',
      n8nGuard: 'Garde-fous (learnings)',
      n8nLoomSoon: 'Démo Loom à venir',
      n8nLoomNote: 'Collez le lien loom.com/share/… dans les données',
      n8nSoonTab: 'À venir',
      n8nRes: 'Ressources & one-pagers',
      n8nResSub: 'Mes aide-mémoires et pages autonomes — cliquez pour ouvrir.',
      n8nResSoon: 'Autre one-pager à venir',
    ...
    EN: {
      ...
      heroCtaProjects: 'Product projects',
      heroCtaAutomations: 'n8n Workflows',
      heroCtaCv: 'My resume',
      n8nCrumb: 'Automations',
      n8nEyebrow: 'Builder · No-code & Automation',
      n8nTitle: 'My automations',
      n8nIntro: 'Pick an automation: Loom demo, node architecture and the skills involved. One demo at a time — nothing loads until you open it.',
      n8nBack: 'Hub',
      n8nNeed: 'The need',
      n8nSolution: 'The solution',
      n8nApps: 'Connected apps',
      n8nSkills: 'n8n skills demonstrated',
      n8nFlow: 'Flow architecture',
      n8nInput: 'Input',
      n8nEngine: 'n8n engine',
      n8nOutput: 'Output',
      n8nSub: 'Sub-workflows',
      n8nGuard: 'Guardrails (learnings)',
      n8nLoomSoon: 'Loom demo coming soon',
      n8nLoomNote: 'Paste the loom.com/share/… link in the data',
      n8nSoonTab: 'Coming soon',
      n8nRes: 'Resources & one-pagers',
      n8nResSub: 'My cheatsheets and standalone pages — click to open.',
      n8nResSoon: 'More one-pagers coming',
